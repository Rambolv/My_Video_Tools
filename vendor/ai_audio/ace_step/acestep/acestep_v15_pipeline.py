...
def main():
    ...
    # Define local outputs directory (override via ACE_STEP_OUTPUT_DIR env var)
    project_root = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    output_dir = os.environ.get("ACE_STEP_OUTPUT_DIR") or os.path.join(project_root, "gradio_outputs")
